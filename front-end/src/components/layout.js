            ...
            <div className="welcome-message">
                <div className="wrap-info">
                    <div className="information">
                        ...
                        <p className="animated fadeInUp">Most luxurious hotel of asia with the royal treatments and excellent
                            customer service.</p>
                    </div>
                    <a href="#information" className="arrow-nav scroll wowload fadeInDownBig"><i
                ...
                <div className="row">
                    <div className="col-sm-7 col-md-8">
                        <div className="embed-responsive embed-responsive-16by9 wowload fadeInLeft">
                            <iframe className="embed-responsive-item" title="w" src="//player.vimeo.com/video/55057393?title=0" width="100%"
                                height="400" frameBorder="0" ></iframe></div>
                    </div>
                ...
                <div className="row">
                    <div className="col-sm-4">
                        ...
                        <div id="RoomCarousel" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner">
                                <div className="item active"><img src="images/photos/8.jpg" className="img-responsive" alt="slide" />
                                </div>
                                <div className="item  height-full"><img src="images/photos/9.jpg" className="img-responsive"
                                    alt="slide" /></div>
                                <div className="item  height-full"><img src="images/photos/10.jpg" className="img-responsive"
                                    alt="slide" /></div>
                            </div>

                            <a className="left carousel-control" href="#RoomCarousel" role="button" data-slide="prev"><i
                    ...
                    <div className="col-sm-4">
                        <div id="TourCarousel" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner">
                                <div className="item active"><img src="images/photos/6.jpg" className="img-responsive" alt="slide" />
                                </div>
                                <div className="item  height-full"><img src="images/photos/3.jpg" className="img-responsive"
                                    alt="slide" /></div>
                                <div className="item  height-full"><img src="images/photos/4.jpg" className="img-responsive"
                                    alt="slide" /></div>
                            </div>

                            <a className="left carousel-control" href="#TourCarousel" role="button" data-slide="prev"><i
                                className="fa fa-angle-left"></i></a>
                    ...
                    <div className="col-sm-4">
                        <div id="FoodCarousel" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner">
                                <div className="item active"><img src="images/photos/1.jpg" className="img-responsive" alt="slide" />
                                </div>
                                <div className="item  height-full"><img src="images/photos/2.jpg" className="img-responsive"
                                    alt="slide" /></div>
                                <div className="item  height-full"><img src="images/photos/5.jpg" className="img-responsive"
                                    alt="slide" /></div>
                            </div>

                            <a className="left carousel-control" href="#FoodCarousel" role="button" data-slide="prev"><i
                                className="fa fa-angle-left"></i></a>
                ...
                <div className="row">
                    ...
                    <div className="col-sm-4 subscribe">
                        ...
                        <div className="social">
                            <a href="#"><i className="fa fa-facebook-square" data-toggle="tooltip" data-placement="top"
                                data-original-title="facebook"></i></a>
                            <a href="#"><i className="fa fa-instagram" data-toggle="tooltip" data-placement="top"
                                data-original-title="instragram"></i></a>
                            <a href="#"><i className="fa fa-twitter-square" data-toggle="tooltip" data-placement="top"
                                data-original-title="twitter"></i></a>
                            <a href="#"><i className="fa fa-pinterest-square" data-toggle="tooltip" data-placement="top"
                                data-original-title="pinterest"></i></a>
                            <a href="#"><i className="fa fa-tumblr-square" data-toggle="tooltip" data-placement="top"
                                data-original-title="tumblr"></i></a>
                            <a href="#"><i className="fa fa-youtube-square" data-toggle="tooltip" data-placement="top"
